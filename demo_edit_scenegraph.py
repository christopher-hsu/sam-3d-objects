...
Allows you to edit the big scene graph, i.e remove add objects and itll load the scene graph and recombine all the glbs into one glb
as well as regenerate per step glbs
"""
...
def scenegraph_to_mesh(dataset_dir: str) -> None:
...
def main():
    ...
    scenegraph_to_mesh(dataset_dir)
